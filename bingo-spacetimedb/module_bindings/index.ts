...
export class RemoteReducers {
  ...
  authenticateClient(steamId: string) {
    const __args = { steamId };
  ...
  onAuthenticateClient(callback: (ctx: ReducerEventContext, steamId: string) => void) {
    this.connection.onReducer("AuthenticateClient", callback);
  }

  removeOnAuthenticateClient(callback: (ctx: ReducerEventContext, steamId: string) => void) {
